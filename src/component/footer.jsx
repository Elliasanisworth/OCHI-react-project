...
function footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 px-16 py-14 flex gap-5 font-["Founders_Grotesk_X-Condensed"] '>
        <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className="heading">
        <h1 className='text-[8vw] tracking-wide font-semibold  uppercase leading-none -mb-7 '>eye-</h1>
        <h1 className='text-[8vw] tracking-wide font-semibold uppercase leading-none -mb-7 '>Opening</h1>
        </div>
        <svg width="72" height="35" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='dets font-["Neue_Montreal"] mt-11'>
            ...
            <a className='block text-lg font-light' href="#">Linkedin</a>
        </div>
        <div className='dets font-["Neue_Montreal"] mt-7 flex justify-between'>
          <div>
            <h3 className='mb-3'>L:</h3>
            ...
            <a className='block text-lg font-light mt-7' href="#">30 Chukarina St</a>
          ...
          <div>
            ...
            <a className='block text-lg font-light' href="#">Insigths</a>
            <a className='block text-lg font-light' href="#">Contact Us</a>
          </div>
        </div>
        <div className='dets font-["Neue_Montreal"] mt-7'>
            <h3 className='mb-3'>E:</h3>
            <a className='block text-lg font-light tracking-wide' href="#">hello@ochi.design</a>
        </div>
        <div className='w-full font-["Neue_Montreal"]  text-zinc-600 mt-9 tracking-widest text-sm flex justify-between'>
            <h1>&copy; ochi design 2024. <a className='text-zinc-400' href="#">Legal Terms</a> </h1>
            <h1>Website by Shashwat</h1>
        </div>
        </div>
    </div>
  )
